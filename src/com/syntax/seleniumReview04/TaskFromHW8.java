package com.syntax.seleniumReview04;
...
public class TaskFromHW8 {
    ...
    // find the disable button
        ...
        disableBtn.click();
    // locate the text is disabled to make sure the textbox is disabled
        WebElement disableText = driver.findElement(By.xpath("//p[text() = \"It's disabled!\"]"));
        String textDisabled = disableText.getText();
        System.out.println(textDisabled);
    // check if the textbox is actually disabled now
        if(!txtBox.isEnabled()){
